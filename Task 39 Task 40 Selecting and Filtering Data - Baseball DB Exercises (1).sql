...
*/
-- Your query below:
select playerID, yearID, ERA from pitching
where ERA < 2.50;
...
*/
-- Your query below:
select teamID, name, yearId from teams
where lgID = 'AL';
...
*/
-- Your query below:
select teamID, name, lgID from teams
where lgID != 'NL';
...
*/
-- Your query below:
select nameFirst, nameLast, debut_date from people
where debut_date < '1950-01-01';
...
*/
-- Your query below:
select nameFirst, nameLast, death_date from people
...
*/
-- Your query below:
select playerID, yearID, HR, lgID from batting
where HR > 40 AND lgID = 'NL';